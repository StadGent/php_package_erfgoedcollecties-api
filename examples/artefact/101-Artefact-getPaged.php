 ...
 *
 * Example how to get a list of all available Artefacts.
 *
...
example_print_header('Example how to get a list of all available Artefacts.');
...
example_print_step('Get the first 100 artefacts.');
example_print();

try {
    $response = $artefact->getPaged();
